...
class ZBP_Waitlist_Service {
    ...
    private function render_decline_waitlist_confirmation( $entry_id, $token, $product_id, $event_date, $redirect_url ) {
        ...
        wp_head();
        echo '<style>.zbp-decline-page{min-height:100vh;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.72);padding:24px;box-sizing:border-box}.zbp-decline-dialog{width:min(540px,100%);background:#3F3E3E;color:#f6f2ea;border-radius:12px;box-shadow:0 24px 80px rgba(0,0,0,.34);padding:48px 32px 36px;text-align:center;box-sizing:border-box}.zbp-decline-dialog h1{color:#D8B355;font-size:28px;font-weight:700;line-height:1.25;margin:0 0 18px}.zbp-decline-dialog p{color:#f6f2ea;font-size:20px;line-height:1.45;margin:0 0 34px}.zbp-decline-actions{display:flex;flex-direction:column;gap:34px}.zbp-decline-actions a{align-items:center;background:transparent;border:3px solid currentColor;border-radius:999px;box-sizing:border-box;display:inline-flex;font-size:24px;font-weight:700;justify-content:center;line-height:1.2;min-height:88px;padding:18px 28px;text-align:center;text-decoration:none;width:100%}.zbp-decline-confirm,.zbp-decline-confirm:visited{color:#D8B355}.zbp-decline-cancel,.zbp-decline-cancel:visited{color:#9A9A9A}.zbp-decline-confirm:hover,.zbp-decline-confirm:focus,.zbp-decline-cancel:hover,.zbp-decline-cancel:focus{background:rgba(255,255,255,.04);color:currentColor}@media(max-width:640px){.zbp-decline-dialog{padding:34px 20px 26px}.zbp-decline-dialog h1{font-size:22px}.zbp-decline-dialog p{font-size:17px}.zbp-decline-actions{gap:20px}.zbp-decline-actions a{font-size:18px;min-height:64px}}</style></head><body>';
        ...
        echo '<div class="zbp-decline-actions"><a class="zbp-decline-confirm" href="' . esc_url( $confirm_url ) . '">' . esc_html__( 'Release spot', 'zen-bookpro' ) . '</a><a class="zbp-decline-cancel" href="' . esc_url( $redirect_url ) . '">' . esc_html__( 'Cancel', 'zen-bookpro' ) . '</a></div>';
        echo '</section></main>';
        wp_footer();
        echo '</body></html>';
    }
